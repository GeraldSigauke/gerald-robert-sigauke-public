    ...
    <>
      <div class="mb-6 lg:mb-0">
        <div id="innards" class="lp-innards relative block bg-white dark:bg-[#1F2937] rounded-lg shadow-lg">
          <div class="flex">
            <div
              class="lp-img relative overflow-hidden bg-no-repeat bg-cover bg-no-repeat bg-cover shadow-lg rounded-lg mx-4 -mt-4"
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
            >
              <img id='' src={lp.img} class="lp-img-1 w-full" />
              <img id='' src={lp.img2} class="lp-img-2 w-full" />
