            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-6/12">
              <div class="px-6 py-12 md:px-12">
                ...
                <p class="text-gray-500">
                  My weapons of choice are Mongo DB, Express Js, React, Node Js and Tailwind CSS. Obviously, this means that I know HTML, CSS and Javascript at a more than decent level. Right now, I am mastering React Native. In the future, I wish to take up Typescript. It is worth noting that, prior to taking up the MERN stack, I -- among many other things -- learned SQL, PHP, XML, Python and Java.
                </p>
              </div>
            </div>
          </div>
